...
from date_helpers import get_todays_date, validate_date
...
def get_entry_data(connection: Connection, console: Console, date: date):
    ...
    console.print(f"{date} | {description} for {times_worked_values}", style=info_style)
